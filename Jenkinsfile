pipeline {
    ...
    stages {
        stage('SCM Checkout'){
            steps {
            git branch: 'main', url: 'https://github.com/dhinesh1311/microservices.git'
            sh 'ls'
            }
        }
                        ...
                        script{
                            dir('wishlist-microservice-python') {
                                ...
                                withSonarQubeEnv('sonar-pro') {
                                    ...
                                    -D sonar.host.url=http://13.127.107.172:9000/"""
                                }
                            }
                        }
                    }
            ...
            steps {
                parallel (
                    ...
                    'ui-web-app-reactjs': {
                        dir('ui-web-app-reactjs'){
                            sh """
                            docker build -t dhinesh1311/ui:v1 .
                            docker push dhinesh1311/ui:v1
                            docker rmi dhinesh1311/ui:v1
                            """
                        }
                    },
                    'zuul-api-gateway' : {
                        dir('zuul-api-gateway'){
                            sh """
                            docker build -t dhinesh1311/api:v1 .
                            docker push dhinesh1311/api:v1
                            docker rmi dhinesh1311/api:v1
                            """
                        }
                    },
                    'offers-microservice-spring-boot': {
                        dir('offers-microservice-spring-boot'){
                            sh """
                            docker build -t dhinesh1311/spring:v1 .
                            docker push dhinesh1311/spring:v1
                            docker rmi dhinesh1311/spring:v1
                            """
                        }
                    },
                    'shoes-microservice-spring-boot': {
                        dir('shoes-microservice-spring-boot'){
                            sh """
                            docker build -t dhinesh1311/spring:v2 .
                            docker push dhinesh1311/spring:v2
                            docker rmi dhinesh1311/spring:v2
                            """
                        }
                    },
                    'cart-microservice-nodejs': {
                        dir('cart-microservice-nodejs'){
                            sh """
                            docker build -t dhinesh1311/ui:v2 .
                            docker push dhinesh1311/ui:v2
                            docker rmi dhinesh1311/ui:v2
                            """
                        }
                    },
                    'wishlist-microservice-python': {
                        dir('wishlist-microservice-python'){
                            sh """
                            docker build -t dhinesh1311/python:v1 .
                            docker push dhinesh1311/python:v1
                            docker rmi dhinesh1311/python:v1
                            """
                        }
                    }
                )
